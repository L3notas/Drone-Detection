...
class DroneDetectionApp:
    ...
    Attributes:
        root (Tk): The main Tk GUI window.
        detection_times (list): List of detection timestamps.
        detection_details (list): List of detection etail dictionaries.
    ...
    def __init__(self, root):
        ...
        self.detector = DroneDetector(
            "C:/Users/liam_/OneDrive/Documents/Drone-Detection/Drone-Detection/models/best.pt",
